/* ═══════════════════════════════════════════════════════════════════════════
   El Periódico de IAPÑ — News data layer
   "Datos, no ideología. Soluciones, no promesas."
   Generated articles from the perspective of the fictional party Partido IAPÑ,
...
export const articles: NewsArticle[] = [
  // ── 1. PORTADA — Fraude fiscal ──────────────────────────────────────────
  {
    ...
    headline:
      "España pierde 70.000M€ al año en fraude fiscal: IAPÑ propone 5.000 inspectores",
    subheadline:
      "La economía sumergida representa el 20% del PIB según estimaciones del FMI y la AEAT",
    category: "economia",
    date: "2026-04-10",
    author: "Redacción El Periódico de IAPÑ",
    summary:
      "El fraude fiscal en España asciende a unos 70.000 millones de euros anuales, según estimaciones cruzadas de la AEAT, el Banco de España y el FMI. La cifra equivale al presupuesto combinado de Sanidad y Educación. El Partido IAPÑ ha presentado un plan para contratar 5.000 nuevos inspectores tributarios en tres años con el objetivo de recuperar 15.000 millones anuales adicionales para las arcas públicas.",
    body: [
  ...
  // ── 2. PORTADA — NGEU estancado ────────────────────────────────────────
  {
    ...
    iapnProposal:
      "[PROPUESTA IAPÑ] Ley de Aceleración NGEU: creación de una ventanilla única digital para la gestión de fondos europeos, con plazo máximo de adjudicación de 60 días. Simplificación de requisitos documentales, creación de 200 equipos técnicos de apoyo a comunidades autónomas y ayuntamientos, y dashboard público de seguimiento en tiempo real.",
    iapnQuote:
      "«Los fondos europeos son una oportunidad generacional. Cada día de retraso es dinero que no se invierte en el futuro de España.» — Portavocía de IAPÑ",
    blockers: [
      {
  ...
  // ── 3. Desempleo juvenil ───────────────────────────────────────────────
  {
    ...
    summary:
      "El desempleo juvenil en España se sitúa en el 26,3% según la última EPA del INE, publicada el 25 de marzo de 2026. La tasa duplica la media de la Unión Europea (11,8%) y solo Grecia (27,1%) presenta una cifra superior. El Partido IAPÑ ha propuesto una Ley de Empleo Garantizado que sustituiría los subsidios pasivos por programas de empleo activo con formación integrada.",
    body: [
  ...
  // ── 4. Vivienda ────────────────────────────────────────────────────────
  {
    ...
    summary:
      "El alquiler medio en Madrid y Barcelona alcanza los 1.150€ y 1.080€ mensuales respectivamente, lo que supone un 45% y un 42% del salario medio neto según datos del portal Idealista y el INE. La tasa de esfuerzo supera el 30% recomendado por la UE en 12 de 17 CCAA. El Partido IAPÑ propone una reforma integral del mercado de vivienda que incluye topes al alquiler, incentivos fiscales y la construcción de 100.000 viviendas públicas al año.",
    body: [
  ...
  // ── 6. Transparencia ──────────────────────────────────────────────────
  {
    ...
    iapnProposal:
      "[PROPUESTA IAPÑ] Ley de Transparencia 2.0: dashboard público de gasto en tiempo real con desglose por ministerio, programa y proveedor. Publicación obligatoria de todos los contratos (incluidos menores). Capacidad sancionadora para el Consejo de Transparencia. Declaración de patrimonio obligatoria y verificable para todos los cargos públicos. Plazo máximo de 15 días para responder solicitudes de información.",
    iapnQuote:
      "«Si el Estado exige transparencia fiscal a los ciudadanos, los ciudadanos tienen derecho a exigir transparencia presupuestaria al Estado.» — Portavocía de IAPÑ",
    blockers: [
      {
  ...
  // ── 7. Semiconductores ────────────────────────────────────────────────
  {
    ...
    iapnProposal:
      "[PROPUESTA IAPÑ] Ley de Reindustrialización Estratégica: inversión de 3.000M€/año en I+D+i industrial (objetivo: 3% del PIB), especialización en semiconductores de potencia (SiC/GaN), fotónica y sensores. Creación de un «Sandbox Industrial» con fiscalidad reducida para fábricas de semiconductores. Formación de 10.000 ingenieros especializados en 5 años mediante becas STEM.",
    iapnQuote:
      "«España no necesita competir con Taiwán. Necesita encontrar su nicho estratégico y dominarlo. Los chips de potencia para la transición energética son nuestra oportunidad.» — Portavocía de IAPÑ",
    blockers: [
      {
  ...
  // ── 8. Déficit y reglas fiscales ──────────────────────────────────────
  {
    ...
    summary:
      "Las nuevas reglas fiscales de la UE, vigentes desde enero de 2025, exigen a España un ajuste del déficit estructural de 1,7 puntos de PIB en un plazo de 4 años (ampliable a 7 si se presentan reformas estructurales). El déficit público español cerró 2025 en el 3,6% del PIB y la deuda en el 105%. El Partido IAPÑ propone una Reforma de Estabilidad Presupuestaria que diferencie gasto corriente e inversión productiva.",
    body: [
    ...
    iapnProposal:
      "[PROPUESTA IAPÑ] Reforma de Estabilidad Presupuestaria: diferenciar gasto corriente (sometido a las reglas fiscales) de inversión productiva (excluida del cómputo de déficit). Compromiso de ejecución del 100% de los fondos NGEU. Creación de un fondo de estabilización fiscal anticíclico dotado con el 0,5% del PIB/año en periodos de crecimiento.",
    iapnQuote:
      "«La austeridad indiscriminada mata el crecimiento. Un país que no invierte en su futuro no puede reducir su deuda.» — Portavocía de IAPÑ",
    blockers: [
      {
        actor: "Comisión Europea",
        reason:
  ...
  // ── 11. NGEU y cohesión territorial ───────────────────────────────────
  {
    ...
    iapnProposal:
      "[PROPUESTA IAPÑ] Reforma de la distribución NGEU: asignar al menos el 40% de los fondos restantes a las 8 CCAA con indicadores críticos. Creación de 200 equipos técnicos de apoyo para mejorar la capacidad de gestión de las CCAA menos dotadas. Criterios de asignación que ponderen necesidad territorial (40%), calidad del proyecto (40%) y capacidad de ejecución (20%).",
    iapnQuote:
      "«Los fondos europeos deben ser un instrumento de convergencia, no de divergencia. Si llegan solo a quien ya tiene, ampliamos la brecha.» — Portavocía de IAPÑ",
    blockers: [
      {
...
El Partido IAPÑ nace de una premisa simple: las decisiones políticas deben basarse en datos verificables, evidencia internacional y análisis coste-beneficio riguroso. No somos de izquierdas ni de derechas: somos de lo que funciona.
...
Soluciones, no promesas. Datos, no ideología. Este es el periodismo —y la política— que España necesita.`,
    author: "Comité Editorial — El Periódico de IAPÑ",
    date: "2026-04-10",
    disclaimer:
      "NOTA: Este texto es un editorial de opinión del Partido IAPÑ. No constituye información periodística neutral. Las opiniones expresadas son las del partido y deben evaluarse como tales.",
  },
  {
...
const METHODOLOGY = `El Periódico de IAPÑ utiliza una metodología de análisis basada en datos públicos y verificables:
...
5. SEPARACIÓN INFORMACIÓN/OPINIÓN: El cuerpo de cada artículo es estrictamente factual y neutral. Las propuestas de IAPÑ están claramente etiquetadas como [PROPUESTA IAPÑ]. Los editoriales llevan aviso explícito de que son opinión.
