...
const SPENDING: SpendingCategory[] = [
  ...
  },
  {
    ...
    icon: "🛡️",
    color: "#475569",
    description: "Fuerzas Armadas, misiones internacionales, equipamiento militar, NATO",
    percentOfState: 3.1,
    percentOfCcaa: 0,
  ...
  },
  {
    ...
    icon: "👮",
    color: "#1e40af",
    description: "Policía Nacional, Guardia Civil, instituciones penitenciarias, tribunales, fiscalía",
    percentOfState: 4.5,
    percentOfCcaa: 3.5,
  ...
  },
  {
    ...
    icon: "🚄",
    color: "#7c3aed",
    description: "Carreteras, AVE, puertos, aeropuertos, transportes públicos, vivienda",
    percentOfState: 3.8,
    percentOfCcaa: 7.5,
    examples: ["17.000 km red estatal", "3.800 km de AVE", "49 aeropuertos AENA"],
  },
  {
    ...
    icon: "🤝",
    color: "#be185d",
    description: "Dependencia, discapacidad, IMV, protección a familias, vivienda social, inclusión",
    percentOfState: 3.5,
    percentOfCcaa: 10.0,
  ...
  },
  {
    ...
    icon: "🔬",
    color: "#0891b2",
    description: "I+D civil, CSIC, universidades, programas europeos, transferencia tecnológica",
    percentOfState: 2.8,
    percentOfCcaa: 2.0,
  ...
  },
  {
    ...
    icon: "🗺️",
    color: "#b45309",
    description: "Financiación autonómica: fondo de suficiencia, nivelación, convergencia y cooperación",
    percentOfState: 14.8,
    percentOfCcaa: 0,
  ...
  },
  {
    ...
    icon: "🎭",
    color: "#4f46e5",
    description: "Museos, bibliotecas, patrimonio, deportes, industria cultural, propiedad intelectual",
    percentOfState: 0.8,
    percentOfCcaa: 3.5,
    examples: ["67 museos estatales", "Prado, Reina Sofía", "CSD, ADO"],
  },
  {
    id: "medioambiente",
    name: "Medio ambiente",
    icon: "🌿",
    color: "#15803d",
    description: "Protección ambiental, gestión de residuos, agua, parques nacionales, transición energética",
    percentOfState: 1.5,
    percentOfCcaa: 4.0,
    examples: ["16 parques nacionales", "Plan PNIEC 2030", "Gestión hidráulica"],
  },
  {
    id: "accion-exterior",
    ...
    icon: "🌍",
    color: "#9333ea",
    description: "Servicio exterior, cooperación al desarrollo, contribución al presupuesto de la UE, consulados",
    percentOfState: 4.2,
    percentOfCcaa: 0,
    examples: ["Contribución UE: ~15.000M€", "AECID", "118 embajadas"],
  },
  {
    id: "otros",
    name: "Otros gastos y administración",
    icon: "🏛️",
    color: "#78716c",
    description: "Administración general, órganos constitucionales, servicios comunes, imprevistos",
    percentOfState: 5.5,
    percentOfCcaa: 8.5,
    examples: ["Gobierno, Congreso, Senado", "TC, Defensor del Pueblo", "AAPP y servicios comunes"],
  },
];
